...
lab.experiment('When authenticating an admin email', () => {
    ...
    lab.test('should successfully return userId if email is authenticated', async () => {
        ...
        const res = await Server.server.inject(`/authenticate/admin/${emailToAuthenticate}`);
    ...
    lab.test('should return 401 if email belongs to a user, but user is not an admin', async () => {
